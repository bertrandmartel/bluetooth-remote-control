...
#define PSTORAGE_NUM_OF_PAGES       40                                                         /**< Number of flash pages allocated for the pstorage module excluding the swap page, configurable based on system requirements. */
...
#define PSTORAGE_CMD_QUEUE_SIZE     40                                                          /**< Maximum number of flash access commands that can be maintained by the module for all applications. Configurable. */
