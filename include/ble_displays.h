...
#define DISPLAYS_UUID_TRANSMIT_STATUS 0x1803
...
typedef void (*ble_displays_transmit_status_write_handler_t) (ble_displays_t * p_dis, uint8_t transmit_status);
...
typedef struct
{
	...
	ble_displays_transmit_status_write_handler_t  transmit_status_handler;
...
typedef struct ble_displays_s
{
	...
	ble_gatts_char_handles_t                          transmit_status_handles;
